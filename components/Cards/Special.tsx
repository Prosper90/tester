...
const cardData: CardData[] = [
  { title: "KYC", baseProfit: 10, baseUpgradeCost: 100, levelRequired: 0, description: "Improve your search engine rankings." },
  { title: "KYB", baseProfit: 500, baseUpgradeCost: 500, levelRequired: 0, description: "Enhance your marketing strategies." },
  { title: "Legal opinion", baseProfit: 60, baseUpgradeCost: 1000, levelRequired: 0, description: "Strengthen your IT infrastructure." },
  { title: "SEC transparancy", baseProfit: 60, baseUpgradeCost: 50, levelRequired: 0, description: "Boost customer support efficiency.", requiredCard: { title: "Legal opinion", level: 5 }, extraCost: 50 },
  { title: "Licence UAE", baseProfit: 560, baseUpgradeCost: 100, levelRequired: 0, description: "Create and share video content.", requiredCard: { title: "KYC", level: 5 }, extraCost: 100 },
  { title: "Licence Europe", baseProfit: 720, baseUpgradeCost: 250, levelRequired: 0, description: "Create and share video content.", requiredCard: { title: "KYC", level: 5 }, extraCost: 250 },
  { title: "Licence Asia", baseProfit: 370, baseUpgradeCost: 150, levelRequired: 0, description: "Create and share video content.", requiredCard: { title: "KYC", level: 5 }, extraCost: 150 },
  { title: "Anti money loundering", baseProfit: 280, baseUpgradeCost: 3000, levelRequired: 0, description: "Build your social media presence." },
];

export default function Special({ userPoints, setUserPoints, cardLevels, setCardLevels, updateProfitPerHour }: SpecialProps) {
